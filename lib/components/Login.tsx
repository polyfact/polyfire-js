...
function GithubButton({ onClick }: { onClick: () => void }) {
    return (
        <button
            ...
            className="border rounded bg-[#24292e] hover:bg-[#2b3137]"
        >
            <svg
                aria-hidden="true"
                fill="currentColor"
...
function MicrosoftButton({ onClick }: { onClick: () => void }) {
    return (
        <button
            onClick={onClick}
            style={{
            ...
            className="border rounded bg-white hover:bg-gray-100"
        >
            <svg
        ...
        return (
            <div {...props} style={{ width: 240, minHeight: 145, ...(props.style || {}) }}>
                {providers.map((p) => {
                    switch (p) {
                        case "github":
                            return <GithubButton onClick={() => login("github")} />;
                        case "google":
                            return <GoogleButton onClick={() => login("google")} />;
                        case "azure":
                            return <MicrosoftButton onClick={() => login("azure")} />;
                        default:
                            return null;
                    }
                })}
