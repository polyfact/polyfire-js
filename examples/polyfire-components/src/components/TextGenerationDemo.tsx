...
const TextGeneratedDemo = () => {
    ...
    return (
        <div className="mb-6">
            <h3 className="text-md bg-stone-800 font-bold mb-4">Dynamic Text Generation</h3>
            ...
            <TextGenerated prompt={prompt} stream={stream} />

            <h4 className="font-semibold my-2">Code</h4>
            <CodeDisplay code={`<TextGenerated prompt={"${prompt}"} stream={${stream}} />`} />
        </div>
    );
};

export default TextGeneratedDemo;
